...
//  "imageID": "docker-pullable://registry.gitlab.company.com/antiopa/dev@sha256:05f5cc14dff4fcc3ff3eb554de0e550050e65c968dc8bbc2d7f4506edfcdc5b6"
...
func KubeGetPodImageInfo(podName string) (imageName string, imageId string) {
	res, err := Kubernetes.CoreV1().Pods(KubernetesAntiopaNamespace).Get(podName, metav1.GetOptions{})
...
func KubeUpdateDeployment(imageId string) error {
	deploymentsClient := Kubernetes.AppsV1beta1().Deployments(KubernetesAntiopaNamespace)
